...
echo "RUN wget https://github.com/jwilder/dockerize/releases/download/v0.6.1/dockerize-linux-amd64-v0.6.1.tar.gz && tar -C /usr/local/bin -xzvf dockerize-linux-amd64-v0.6.1.tar.gz && rm dockerize-linux-amd64-v0.6.1.tar.gz"
echo "RUN wget http://sphinxsearch.com/files/sphinxsearch_2.2.10-release-0ubuntu12~trusty_amd64.deb && dpkg -i sphinxsearch_2.2.10-release-0ubuntu12~trusty_amd64.deb && rm sphinxsearch_2.2.10-release-0ubuntu12~trusty_amd64.deb"
